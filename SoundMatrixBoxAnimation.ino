...
uint8_t colData [] = {0x00, 0x18, 0x3C, 0x7E, 0xFF}; // with both colData and rowData = 0x01,
uint8_t rowData [] = {0x00, 0x18, 0x3C, 0x7E, 0xFF}; //...only the top left LED should light up
