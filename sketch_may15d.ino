//Project: Reveiver code for Bi-Wheeled rover
//Author: Josh Dolgin
//Date: 2019/06/26
//Status: Working
#include <RF24.h>
...
void loop() {
  ...
  if (data.xVal < 150 && data.xVal > 100 && data.yVal < 150 && data.yVal > 100) { // if the joystick is in the middle
